window.addEventListener('keydown', function(e) {
    ...
    switch (key) {
        case 37:
            if (document.getElementById('data-input-5') == document.activeElement)
            ...
            break;
        case 38:
            if (displayCells.arrowMod == true)
                displayCells.decrement();
            break;
        case 39:
            if (document.getElementById('data-input-0') == document.activeElement)
                document.getElementById('data-input-1').click();
            else if (document.getElementById('data-input-1') == document.activeElement)
                document.getElementById('data-input-2').click();
            else if (document.getElementById('data-input-2') == document.activeElement)
        ...
        case 65:
            ...
            break;
        case 66:
            document.getElementById('button-B').click();
            break;
        case 67:
        ...
        case 68:
            ...
            break;
        case 69:
            document.getElementById('button-E').click();
            break;
        case 70:
